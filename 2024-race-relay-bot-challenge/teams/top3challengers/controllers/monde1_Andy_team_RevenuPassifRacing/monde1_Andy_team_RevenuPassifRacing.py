...
class AllCam():
    def __init__(self,robot:Robot):
        ...
        self.depth_cam.enable(robot.timestep)
...
class monRobot(Robot):
    ...
    def run(self):
        ...
        if self.x < -10 and self.x > -13 and self.y > 13.5 and self.y < 15.8:
            ...
            # print(self.Cam.depth_cam.getRangeImage())
            # print(self.Cam.depth_cam.getRangeImageArray())
            # print(self.Cam.depth_cam.getRangeImage(data_type='list'))
